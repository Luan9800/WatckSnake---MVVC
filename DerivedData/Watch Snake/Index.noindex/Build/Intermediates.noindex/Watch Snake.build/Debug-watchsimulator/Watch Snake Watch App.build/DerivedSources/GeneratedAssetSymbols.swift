...
extension DeveloperToolsSupport.ImageResource {
    ...
    static let pixelIcon = DeveloperToolsSupport.ImageResource(name: "pixel_icon", bundle: resourceBundle)
...
extension AppKit.NSImage {
    ...
    /// The "pixel_icon" asset catalog image.
    static var pixelIcon: AppKit.NSImage {
#if !targetEnvironment(macCatalyst)
        .init(resource: .pixelIcon)
#else
        .init()
#endif
    }
...
extension UIKit.UIImage {
    ...
    /// The "pixel_icon" asset catalog image.
    static var pixelIcon: UIKit.UIImage {
#if !os(watchOS)
        .init(resource: .pixelIcon)
#else
        .init()
